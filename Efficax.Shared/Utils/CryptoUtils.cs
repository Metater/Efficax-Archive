...
namespace Efficax.Shared.Utils
{
    public static class CryptoUtils
    {
        public static string GetRSAPublicKeyString(RSAParameters rsaPublicKey)
        {
        ...
        public static RSAParameters GetRSAPublicKey(string rsaPublicKeyString)
        {
            StringReader sr = new StringReader(rsaPublicKeyString);
            XmlSerializer xs = new XmlSerializer(typeof(RSAParameters));
            return (RSAParameters)xs.Deserialize(sr);
        }
        public static (RSAParameters, RSAParameters) GenRSAKeyPair(int keySize)
        {
        ...
        public static byte[] RSAEncrypt(byte[] data, RSAParameters rsaPublicKey)
        {
            RSACryptoServiceProvider csp = new RSACryptoServiceProvider();
            csp.ImportParameters(rsaPublicKey);
            return csp.Encrypt(data, true);
        }
        public static byte[] RSADecrypt(byte[] data, RSAParameters rsaPrivateKey)
        {
            RSACryptoServiceProvider csp = new RSACryptoServiceProvider();
